...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 torchrun --nproc_per_node 8 --master_port=29500 torchrun_main.py \
    --model_config configs/llama_71m_96L.json \
    --seed 42 \
    --lr $learning_rates \
    --max_length 1024 \
    --batch_size 16 \
    ...
    --scheduler wsd \
    --grad_clipping 1.0 \
    --prores_warmup_steps 48000 \
    --run_name "71m_96L_res_${norm_type}_lr${learning_rates}" \
    --save_dir "71m_96L_res_${norm_type}_lr${learning_rates}"