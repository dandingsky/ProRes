...
class LlamaDecoderLayer(nn.Module):
    ...
    def forward(
        ...
        if norm_type == 'pre' or norm_type == 'scale_pre':
            ...
            if norm_type == 'deeppost':
                residual = self.deeppost_alpha * residual
            hidden_states = residual + hidden_states
            hidden_states = self.post_attention_layernorm(hidden_states)
        ...
        elif norm_type in ['pre_prores', 'lns_prores']:
            # Pre-LayerNorm Only
            residual = hidden_states
            hidden_states = self.input_layernorm(hidden_states)
            hidden_states, self_attn_weights, present_key_value = self.self_attn(
            ...
            hidden_states = residual + hidden_states * self.alpha
...
class LlamaPreTrainedModel(PreTrainedModel):
    ...
    def _init_weights(self, module):
        ...
        if isinstance(module, nn.Linear):
            ...
            module.weight.data.normal_(mean=0.0, std=std * self.config.hidden_size ** 0.5)
